...
import (
	...
	"github.com/stewelarend/logger/fakelib"
)
...
func TestOne(t *testing.T) {
	...
	w.assert(t, 0, "TestOne", "github.com/stewelarend/logger_test", "DEBUG", "123", map[string]interface{}{})
	w.assert(t, 1, "TestOne", "github.com/stewelarend/logger_test", "DEBUG", "456", map[string]interface{}{"email": "a@b.c"})
	w.assert(t, 2, "TestOne", "github.com/stewelarend/logger_test", "DEBUG", "789", map[string]interface{}{})
	w.assert(t, 3, "TestOne", "github.com/stewelarend/logger_test", "DEBUG", "101", map[string]interface{}{"email": "j@k.l"})
}
...
func TestFakelibDefault(t *testing.T) {
	...
	logger.Named("github.com/stewelarend/logger/fakelib").SetLevel(logger.LevelInfo)
	t.Logf("ALL LOGGERS:")
	for _, l := range logger.All() {
		showLogger(t, l)
	}
	...
	//or switch to debug:
	logger.Named("github.com/stewelarend/logger/fakelib").SetLevel(logger.LevelDebug)
	t.Logf("ALL LOGGERS:")
	for _, l := range logger.All() {
		showLogger(t, l)
	}
